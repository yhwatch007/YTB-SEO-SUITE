...
STATICFILES_DIRS = [
    BASE_DIR / "static",   # only if you have a /static folder; ok to keep even if empty
]
...
# --- API Keys ---
# Using your env object to load all keys from the .env file
YOUTUBE_API_KEY = env("YOUTUBE_API_KEY", default="")
YOUTUBE_DEFAULT_REGION = env("YOUTUBE_DEFAULT_REGION", default="US")
GOOGLE_API_KEY = os.getenv("GOOGLE_API_KEY", "")

# I removed the extra 'load_dotenv()' and 'os.getenv()' from here
# as your django-environ setup at the top already handles it.